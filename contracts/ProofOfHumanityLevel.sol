...
contract ProofOfHumanityLevel {
     ...
     */
    function changeProofOfHumanityCore(IProofOfHumanity _newProofOfHumanityCore)
        external
        onlyGovernor
    {
     ...
     */
    function changeProofOfHumanitySoft(IProofOfHumanity _newProofOfHumanitySoft)
        external
        onlyGovernor
    {
    ...
    function isRegistered(address _submissionID) external view returns (bool) {
        return
            !proofOfHumanitySoft.isRegistered(_submissionID) &&
            proofOfHumanityCore.isRegistered(_submissionID);
    }
